...
- 欢迎使用官方通道：[在线上传音效打标 →](https://skin.gushao.club/docs/extra_service/skin/UploadHandWeb)
- 欢迎使用备用通道：[在线上传音效打标 Mirror →](http://skin.gushao.club/docs/extra_service/skin/UploadHandWebMirror/)
