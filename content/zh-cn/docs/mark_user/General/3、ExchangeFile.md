...
#### 获取流程
1. **作者群** 发送对应的关键词（如 `"普通获取XXX"`）
2. **等待邮箱接收文件兑换码**，前往小程序 **「JuneOver24 Service」** 兑换
3. 下载文件并导入使用

---

### 高级版（Pro专属）
**功能更强大，支持高级参数，首次使用需验证手机号。**

#### 皮肤关键词（去掉"普通"前缀）
- **获取苹果/安卓XXX** （XXX 为皮肤名字）
- **快速获取苹果/安卓XXX**
- **一键获取苹果/安卓**
- **获取苹果/安卓N天内更新**
...
#### 获取流程
1. **作者群** 发送对应的关键词（如 `"获取XXX"`）
2. **首次使用** 需私聊 Bot 发送 `"手机号" "验证码"`
3. **等待邮箱接收文件兑换码**，前往小程序 **「JuneOver24 Service」** 兑换
4. 下载文件并导入使用
...
### 兑换方式
前往小程序 **「JuneOver24 Service」** 兑换。

### 获取流程
1. 进入小程序 **「JuneOver24 Service」**
2. 点击 **「卡密兑换」** 功能
3. 输入卡密进行兑换
